...
public class Login extends HttpServlet {
   ...
   @Override
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        UserInfo admin =getUserInfo(username, password); 
	...
	private UserInfo getUserInfo(String uname, String password) {
        ...
        uf.addBook(new BookBorrowed("Game of Thrones", "George R.R Martin",  true));
        uf.addBook(new BookBorrowed("The Great Gasby", "Sufian Showes",  true));
        uf.addBook(new BookBorrowed("House of Highlights", "George Davidson",  false));
        uf.addBook(new BookBorrowed("Batman", "Bob Knight",  true));
        uf.addBook(new BookBorrowed("John The Soldier", "Roman Reigns", false));
    	return uf;
	}
	@Override
